...
function getCategoriesLabels(categories: string[]): string[] {
...
function getComments(commentsSentences: string[], authors: IAuthorId[]): ICommentCreating[] {
...
function getCommentText(sentences: string[]): string {
  return shuffle(sentences)
